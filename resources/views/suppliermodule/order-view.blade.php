...
<body>
    <div class="sidebar">
        ...
        <a href="{{ route('view.medicine') }}"><i class="fas fa-boxes"></i> <span>Inventory</span></a>
        ...
        <a href="{{ route('purchase.report') }}"><i class="fas fa-chart-bar"></i> <span>Reports</span></a>
    </div>


    <div class="header">
        <h1>{{ $supplier ? 'Filtered' : 'All' }} Pending Orders</h1>
        <div class="header-actions">
            <button class="btn btn-primary" id="toggleDarkMode">
                <i class="fas fa-moon"></i> <span>Dark Mode</span>
            </button>
            @if($supplier)
                <button class="btn btn-warning" onclick="window.location.href='{{ route('pending.orders', ['sup_id' => $supplier->sup_id]) }}'">
                    <i class="fas fa-list"></i> <span>View Completed Orders for this Supplier</span>
                </button>
            @else
                <button class="btn btn-warning" onclick="window.location.href='{{ route('pending.orders') }}'">
