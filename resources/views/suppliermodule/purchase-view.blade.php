...
<body>
    <div class="sidebar">
        ...
        <a href="{{ route('pending.orders') }}" class="active"><i class="fas fa-clipboard-list"></i> <span>Orders</span></a>
    </div>
...
<div class="content">
    ...
    <div class="search-container">
        <form method="GET" action="{{ route('purchases.index') }}" class="search-form">
            <input type="text" name="supplier_name" class="search-input" placeholder="Search Supplier..." value="{{ request('supplier_name') }}">
