...
<style>
     body{
                background-image: url(<?php echo e(asset('pharmacybg.jpg')); ?> );
...
<a href="<?php echo e(route('admin.dashboard')); ?>" class="btn btn-danger mb-3">
...
<div class="container">
 ...
 <div class="col-md-6">
  ...
  <a href="<?php echo e(route('view.medicine')); ?>" class="btn btn-outline-primary">
 ...
 <div class="col-md-6">
  ...
  <a href="<?php echo e(route('drugrequests.index')); ?>" class="btn btn-outline-success">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Scollah\Desktop\Drug-Inventory-Management\resources\views/pharmacist-dashboard.blade.php ENDPATH**/ ?>