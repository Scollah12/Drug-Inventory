    ...
    <head>
        ...
        <style>
            *{
            ...
            body{
                background-image: url(<?php echo e(asset('background.avif')); ?> );
...
@keyframes fadeInScale {
              ...
              <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbarLight" aria-labelledby="offcanvasNavbarLightLabel">
                ...
                <div class="offcanvas-body">
                  <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    <li class="nav-item">
                      <a class="nav-link active" aria-current="page" href=" <?php echo e(route('admin.dashboard')); ?>">Home</a>
                    </li>
                  
                        
                        
                      <button class="btn btn-primary" onclick="window.location.href='<?php echo e(route('notifications.create')); ?>'">Send Notification to Users</button><br>
                      <button class="btn btn-primary" onclick="window.location.href= '<?php echo e(route('login')); ?>'">Log Out</button>
    ...
    <div class="main-container container-animation">
        ...
        <a href="<?php echo e(route('pharmacist.dashboard')); ?>">
...
<a href="<?php echo e(route('add_user.form')); ?>">
...
</html><?php /**PATH C:\Users\Scollah\Desktop\Drug-Inventory-Management\resources\views/admin-dashboard.blade.php ENDPATH**/ ?>