...
<body>
        ...
        <tbody>
            <?php $__currentLoopData = $reportData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><?php echo e($row->total_purchases); ?></td>
    ...
    <button onclick="window.location.href='<?php echo e(route('suppliers.index')); ?>'">Back to Dashboard</button>
</body>
</html>

        
<?php /**PATH C:\Users\Scollah\Desktop\Drug-Inventory-Management\resources\views/suppliermodule/report.blade.php ENDPATH**/ ?>